		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aufgabe 2",
									"targetURL": "#deintegratatrainingaufgabe2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"deintegratatrainingaufgabe2-display": {
								"semanticObject": "deintegratatrainingaufgabe2",
								"action": "display",
								"description": "Kurs 16962",
								"title": "Aufgabe 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.integrata.training.16961.lesson.22",
									"url": sap.ui.require.toUrl("de/integrata/training/16961/lesson/2")
								}
							}
						}
					}
