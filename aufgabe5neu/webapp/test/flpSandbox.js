		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flugkunden",
									"targetURL": "#deintegratatrainingfiveaufgabe5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"deintegratatrainingfiveaufgabe5-display": {
								"semanticObject": "deintegratatrainingfiveaufgabe5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.integrata.training.five.aufgabe5",
									"url": sap.ui.require.toUrl("de/integrata/training/five/aufgabe5")
								}
							}
						}
					}
